...
const AddPostForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        tags: "",
        urlToImage: "",
        sortBy: { top: false, popular: false, tranding: false, breakingNews: false },
    })
    ...
    const submitFormHandler = async (e) => {
        ...
        if (result.status === 200) {
            ...
            toast.error("Not Uploaded, Some error occur")
        ...
        <Div className="content">
            ...
            <div className="form-container">
                ...
                <div className="item item-7">
                    ...
                    <div className="check">
                        <span><input type="checkbox" name='top' onChange={(e) => addSortBy(e)} /> Top </span>
                        <span><input type="checkbox" name='popular' onChange={(e) => addSortBy(e)} /> Popular</span>
                        <span><input type="checkbox" name='tranding' onChange={(e) => addSortBy(e)} /> Tranding </span>
                        <span><input type="checkbox" name='breakingNews' onChange={(e) => addSortBy(e)} /> Breaking News </span>
                ...
                <div className="item button">
                    <button className='btn' onClick={(e) => { submitFormHandler(e) }}>{loading ? <Spinner/> : "Publish"}</button>
                </div>
            </div>
        </Div>
    )
